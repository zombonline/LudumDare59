...
namespace EPOOutline
{
    ...
    public class Outliner : MonoBehaviour
    {
        ...
        private void SetupOutline(Camera cameraToUse, OutlineParameters parametersToUse, bool isEditor)
        {
            ...
            parametersToUse.DepthTestKind = DepthTestKind.ZBuffer;
        ...
        public void ReplaceHandles(OutlineParameters parametersToUpdate)
        {
            Replace(ref parametersToUpdate.Handles.Target, parametersToUpdate.TargetWidth, parametersToUpdate.TargetHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Target"));
            
            Replace(ref parametersToUpdate.Handles.FinalizationTarget, parametersToUpdate.TargetWidth, parametersToUpdate.TargetHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Finalization target"));
            
            Replace(ref parametersToUpdate.Handles.FinalizationStencilTarget, parametersToUpdate.TargetWidth, parametersToUpdate.TargetHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, true, "Finalization stencil target"));
            ...
            Replace(ref parametersToUpdate.Handles.InfoTarget, parametersToUpdate.TargetWidth, parametersToUpdate.TargetHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Info target"));
            ...
            Replace(ref parametersToUpdate.Handles.PrimaryTarget, scaledWidth, scaledHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Primary target"));
            
            Replace(ref parametersToUpdate.Handles.SecondaryTarget, scaledWidth, scaledHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Secondary target"));
            
            Replace(ref parametersToUpdate.Handles.PrimaryInfoBufferTarget, scaledWidth, scaledHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Primary info target"));
            
            Replace(ref parametersToUpdate.Handles.SecondaryInfoBufferTarget, scaledWidth, scaledHeight, parametersToUpdate,
                (width, height, outlineParameters) => RenderTargetUtility.GetRT(outlineParameters, width, height, false, "Secondary info target"));
        }
