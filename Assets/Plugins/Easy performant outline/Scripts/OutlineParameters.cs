...
{
    public enum DepthTestKind
    {
        ZBuffer,
        DepthTexture
    }

    public enum FinalBlitApproach
    {
        DirectBlit,
        IntermediateTexture
    }
    ...
    public class OutlineParameters : IDisposable
    {
        ...
        public DepthTestKind DepthTestKind;
        ...
        public FinalBlitApproach FinalBlitApproach;

        public Rect Viewport;
        public Rect? TargetViewport;
