...
namespace EPOOutline
{
    ...
    public static class RenderTargetUtility
    {
        ...
        public static RTHandle GetRT(OutlineParameters parameters, int width, int height, bool stencilTarget, string name)
        {
            ...
            var result = OutlineEffect.HandleSystem.Alloc(width, height,
                ...
                depthBufferBits: (stencilTarget ? DepthBits.Depth24 : DepthBits.None),
                name: name);
#else
            var result = OutlineEffect.HandleSystem.Alloc(width, height,
                info.Descriptor.volumeDepth,
                stencilTarget ? DepthBits.Depth24 : DepthBits.None,
